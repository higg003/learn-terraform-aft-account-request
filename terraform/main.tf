module "DashStats003" {
  ...
  control_tower_parameters = {
    AccountEmail              = "cloudops.support+199@sonymusic.com"
    AccountName               = "sme-dash-sandbox-003"
    ManagedOrganizationalUnit = "SME-SANDBOX"
    SSOUserEmail              = "cloudops.support+199@sonymusic.com"
...
module "CloudOpstest03" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "cloudops.support+197@sonymusic.com"
    AccountName               = "sme-cloudops-sandbox-05"
    ManagedOrganizationalUnit = "SME-SANDBOX"
    SSOUserEmail              = "cloudops.support+197@sonymusic.com"
    SSOUserFirstName          = "ClOps"
    SSOUserLastName           = "AFT"
  }
  ...
  change_management_parameters = {
    change_requested_by = "deja001"
    change_reason       = "Testing DynamoDB change"
  }
...
module "Scuba-aft-03" {
  ...
  control_tower_parameters = {
    AccountEmail              = "cloudops.support+198@sonymusic.com"
    AccountName               = "sme-sam-sandbox-03"
    ManagedOrganizationalUnit = "SME-SANDBOX"
    SSOUserEmail              = "cloudops.support+198@sonymusic.com"
    SSOUserFirstName          = "Scuba-GT"
    SSOUserLastName           = "AFT"
  }
